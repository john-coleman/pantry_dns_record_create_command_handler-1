  ...
  module Daemon
    class DnsRecordCreateCommandHandler
      ...
      def handle_message(message)
        ...
        @logger.info "dnscmd #{name_server} /RecordAdd #{domain} #{hostname} /CreatePTR A #{ec2_instance.private_ip_address}"
        dns_record_hash = runner.run_commands "dnscmd #{name_server} /RecordAdd #{domain} #{hostname} /CreatePTR A #{ec2_instance.private_ip_address}"
